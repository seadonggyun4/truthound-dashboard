    ...
    <div className="space-y-6">
      ...
      {format === 'markdown' && (
        <div className="space-y-4 pt-4 border-t">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="include-toc" className="text-sm font-normal">
                Table of Contents
              </Label>
              <p className="text-xs text-muted-foreground">
            ...
            <Switch
              id="include-toc"
              checked={value.customOptions?.includeToc as boolean ?? true}
              onCheckedChange={(checked) => handleCustomOptionChange('includeToc', checked)}
              disabled={disabled}
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="include-badges" className="text-sm font-normal">
                Status Badges
              </Label>
              <p className="text-xs text-muted-foreground">
                Add markdown badges for status
              </p>
            </div>
            <Switch
              id="include-badges"
              checked={value.customOptions?.includeBadges as boolean ?? true}
              onCheckedChange={(checked) => handleCustomOptionChange('includeBadges', checked)}
              disabled={disabled}
            />
          </div>
        </div>
      ...
      {format === 'junit' && (
        <div className="space-y-4 pt-4 border-t">
          <Label className="text-sm font-medium">JUnit XML Options</Label>

          <div className="space-y-2">
            <Label htmlFor="suite-name" className="text-sm font-normal">
              Test Suite Name
            </Label>
            <Input
              id="suite-name"
              value={value.customOptions?.suiteName as string ?? 'DataQuality'}
              onChange={(e) => handleCustomOptionChange('suiteName', e.target.value)}
              placeholder="DataQuality"
              disabled={disabled}
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="include-passed" className="text-sm font-normal">
                Include Passed Tests
              </Label>
              <p className="text-xs text-muted-foreground">
                Include passing validations as test cases
              </p>
            </div>
            <Switch
              id="include-passed"
              checked={value.customOptions?.includePassed as boolean ?? true}
              onCheckedChange={(checked) => handleCustomOptionChange('includePassed', checked)}
              disabled={disabled}
            />
          </div>
        </div>
