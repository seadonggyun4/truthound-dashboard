import _OPmRKifZaW04pk4dIxfQ from '../dictionary/alerts.json' with { type: 'json' };
import _2VgfgAWf6tNuRc9kGVT0 from '../dictionary/anomaly.json' with { type: 'json' };
import _r8WBgJrQMvfEJCnickJy from '../dictionary/catalog.json' with { type: 'json' };
...
import _MBFnVSZk8TptPQt2aHXr from '../dictionary/crossAlerts.json' with { type: 'json' };
...
import _thacTHSF6oezxj36MaFw from '../dictionary/driftMonitor.json' with { type: 'json' };
...
import _tC4oYqfWDQjpMqzgJH4b from '../dictionary/lineage.json' with { type: 'json' };
import _ykJJn52Vyu0GvHZ7MPUj from '../dictionary/maintenance.json' with { type: 'json' };
import _GbKyYPPowZQ2IbERWIXA from '../dictionary/modelMonitoring.json' with { type: 'json' };
